---
title: Using Gatsby Image with Kentico Kontent
date: 2020-02-17
summary: Learn how to leverage the powerful Gatsby Image package with Kentico Kontent's media library.
...
An alternative route would be to create a custom transformer plugin to leverage the [image transformation API](https://docs.kontent.ai/reference/image-transformation) available with Kentico Kontent. Fortunately, this is exactly what I have created with the [@rshackleton/gatsby-transformer-kontent-image](https://www.gatsbyjs.org/packages/@rshackleton/gatsby-transformer-kontent-image/) package.
